...
const Hero = () => {
  return (
    <section className="relative w-full min-h-screen bg-[#EFF5E1] pt-20 md:pt-24 lg:pt-[100px] px-4 md:px-8 lg:px-[0px]">
      <div className="max-w-[1920px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start pt-8 md:pt-16 lg:pt-32">
          <div className="lg:col-span-5 lg:text-right lg:pr-14">
            <p className="font-inter font-normal text-[#2D3B36] lg:pl-18 text-base md:text-lg lg:text-[20px] leading-[120%] md:leading-[100%] max-w-md lg:max-w-[335px] lg:indent-[105px] mb-4">
            ...
            <button
              ...
              className="w-full lg:ml-auto lg:mr-[400px] lg:mt-10
 sm:w-auto px-8 py-3 md:px-10 md:py-4 lg:w-[180px] lg:h-[60px]  rounded-full bg-[#2D3B36] text-[#EFF5E1] font-inter font-medium text-lg md:text-xl lg:text-[20px] transition-all duration-300 hover:bg-[#3A4C44] hover:scale-105 shadow-lg cursor-pointer"
            >
              Shop Now
            </button>
          </div>
          ...
          <div className="lg:col-span-3 flex justify-center lg:justify-end">
            <div className="w-48 h-44 md:w-56 md:h-52 lg:mr-14 lg:w-[222.61px] lg:h-[220px] rounded-[20px] overflow-hidden">
              <img
        ...
        <div className="relative mt-[450px]">
          ...
          <div className="absolute bottom-[70px] left-[50%] -translate-x-[50%]">
            <div className="relative w-fit flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
              ...
              <div className="absolute w-full bottom-[40px] left-0 flex justify-center flex-1 max-w-2xl lg:max-w-none">
                <button
